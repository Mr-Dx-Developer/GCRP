...
Strings = {
    ['press_start'] = 'Press ~INPUT_PICKUP~ to pick up a ball, you will charge $100 to play',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ for change lanes\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Select\n~INPUT_FRONTEND_RRIGHT~ Cancel',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Direction\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Force \n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Change camera\n~INPUT_ATTACK~ Attack\n~INPUT_FRONTEND_RRIGHT~ Cancel',
    ['force'] = 'Force: %s',
    ['strike'] = {'WOOF! LIKE A HAMMER!', 'MARVELOUS!!'},
    ['spare'] = {'Semi Full', 'Good game!'},
    ['x_pinsdown'] = {'Bowling alley', 'Not bad %s you did %s in this game'},
    ['this_occupied'] = 'This bowling alley is full.',
    ['every_occupied'] = 'We are completely full.',
    ['blip'] = 'Bowling Alley',
    ['dont_money'] = 'You do not have enough money'
}