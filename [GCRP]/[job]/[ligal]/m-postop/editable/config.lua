...
HSN.Config = {
    ...
    DiscordBotToken = "MTIwMDI2OTg4NTM3NzM1MTcyMQ.GybD2L.okSpqFw4N6RVdiUyjKoLQ4Fez9Wc6htzLDs8bk", -- discord bot token for user image
...
HSN.Target = function(v, k) 
    if v.show.InteractionHandler == 'qb-target' then
        exports['qb-target']:AddBoxZone("postop" ..k, vector3(v.coord.x, v.coord.y, v.coord.z), 1.5, 1.5, {
            name = "m-postop" .. k,
            debugPoly = false,
            heading = -20,
            minZ = v.coord.z - 2,
