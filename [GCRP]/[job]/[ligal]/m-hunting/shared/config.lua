...
Config.Inventory = 'qs' -- qb , esx , ox_inventory (if you are using a different inventory you can write your default framework e.g QBCore qs-inventory 'qb' or ESX qs-inventory 'esx')
...
Config.VehicleRemovekey = false -- Do NOT Touch if you have any car lock system
