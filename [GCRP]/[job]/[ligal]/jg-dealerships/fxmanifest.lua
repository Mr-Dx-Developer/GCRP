...
server_scripts {"@oxmysql/lib/MySQL.lua", "server/sv-webhooks.lua", "framework/**/sv-*.lua", "server/*.lua", "config-sv.lua"}

ui_page "web/dist/index.html"

files {"web/dist/index.html", "web/dist/**/*"}

escrow_ignore {"main.lua", "config.lua", "config-cl.lua", "config-sv.lua", "framework/**/*", "locales/*.lua", "client/cl-blips.lua", "server/sv-webhooks.lua"}
