...
local Vehicles = {
   ...
   --[[  --- Off-Road (9)
    ...
    --- Custompdm
    { model = 'rmodx6',                  name = 'BMWx6',               brand = 'BMW',             price = 75000,   category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = 'rr21shelbystreet',        name = 'Custom F150',         brand = 'Ford',            price = 100000,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodsvj',                name = 'Lamborghini',         brand = 'Lamborghini',     price = 456000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'rmodr8c',                name = 'Audi R10',            brand = 'Audi',            price = 150000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'rmodjeepg',               name = 'Jeep Gladiator',      brand = 'Jeep',            price = 52000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodcharger69',          name = 'Dodge Charger',       brand = 'Dodge',           price = 82000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'rmodcharger',            name = '2018 Dodge Charger',  brand = 'Dodge',           price = 62000,   category = 'sports',          type = 'automobile', shop = 'pdm' },
    { model = 'kln',                    name = 'Rolls Cullinan',      brand = 'Rolls Royce',     price = 462000,  category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = 'kawagala',               name = 'Kawasaki',            brand = 'Kawasaki',        price = 39050,   category = 'motorcycles',    type = 'automobile', shop = 'pdm' },
    { model = 'kgc10',                  name = 'Nissan Skyline',      brand = 'Nissan',          price = 56000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'fk8',                    name = 'Honda Civic',         brand = 'Honda',           price = 28500,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'fxxkevo',                 name = 'Laferrari',           brand = 'Ferrari',         price = 1408500, category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'c8',                      name = 'Corvette C8',         brand = 'Chevrolet',       price = 130500,  category = 'sports',          type = 'automobile', shop = 'pdm' },
    { model = 'audirs8',                 name = 'Audi Rs8',            brand = 'Audi',            price = 120550,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'autobio',                 name = 'Range Rover',         brand = 'Range Rover',     price = 80150,   category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = 'ben17',                   name = '2017 Bentley',        brand = 'Bentley',         price = 214520,  category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'amrevu23mg',              name = ' Aventador',          brand = 'Lamborghini',     price = 498258,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'alpinab7BLACKEDITION',    name = 'M7 Limited Edition',  brand = 'BMW',             price = 115867,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'amgone',                  name = 'AMG-One',            brand = 'Merecedes',       price = 2705867, category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = '77monte',                 name = '77 Chevy Monte Carlo',brand = 'Chevrolet',       price = 32470  , category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = '6x6',                     name = '6x6 AMG',            brand = 'Merecedes',       price = 182470 , category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = '488sp',                   name = '488 Spider',         brand = 'Ferrari',         price = 526770 , category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = '600ltwb',                 name = 'Mclaren 600lt',      brand = 'McLaren',         price = 386790 , category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = '21rsq8',                 name = 'Audi Q8',           brand = 'Audi',            price = 126720 , category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = '2022jeep',               name = '2022 Jeep',         brand = 'Jeep',            price = 52300 ,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = '16topcargle',            name = '2011 AMG',           brand = 'Merecedes',       price = 40000 ,  category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = '19gv80',                 name = 'Toyota Tundra',      brand = 'Toyota',          price = 61000 ,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = 'rs7bratwa',               name = 'Audi Rs7',           brand = 'Audi',            price = 129080 , category = 'Sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'specialtf',              name = 'Series 3',          brand = 'BMW',             price = 31040 ,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'RoyalCustome39m5_wb',    name = 'Bmw M5',            brand = 'BMW',             price = 47120 ,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = '2ncsx7',                 name = '2020 WB X7',        brand = 'BMW',             price = 102000 , category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = '20xb7',                  name = '2020 X7',           brand = 'BMW',             price = 91000 ,  category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = 'taycanani',             name = '24 Porsche taycan', brand = 'Porsche',         price = 154000 , category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'singer',              name = '911 Porsche',       brand = 'Porsche',         price = 114000 , category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'gt86trust',           name = 'subaru brz',        brand = 'Subaru',          price = 34000 ,  category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'abhawk',            name = '2018 WB Trackhawk', brand = 'Jeep',            price = 144000 , category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = 's63coupe',          name = '63 AMG',            brand = 'Merecedes',       price = 83000 ,  category = 'Coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'hellcatlb',          name = '19 WB Dodge',       brand = 'Dodge',           price = 84500 ,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'charger21',          name = '2021 SRT',          brand = 'Dodge',           price = 78599 ,  category = 'sports',          type = 'automobile', shop = 'pdm' },
    { model = 'gt63mt',             name = 'AMG GT63',          brand = 'Merecedes',       price = 148999 , category = 'sports',          type = 'automobile', shop = 'pdm' },
    { model = 'p1lbwk',              name = 'P1',                brand = 'Mclaren',         price = 1258399 ,category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'rx7veilside',           name = 'rx7veilside',       brand = 'Mazda',           price = 58329 ,  category = 'sports',          type = 'automobile', shop = 'pdm' },
    { model = 'rs7wide',               name = 'Widebody Audi',     brand = 'Audi',            price = 105329 , category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'msls',                   name = 'Mclaren Merecedes', brand = 'Merecedes',       price = 755829 , category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'machewb',                name = 'E Mach',            brand = 'Ford',            price = 105829 , category = 'suvs',            type = 'automobile', shop = 'pdm' },
    { model = 'gtr50',                  name = '2023 GTR',          brand = 'Nissan',          price = 122970 , category = 'sports',          type = 'automobile', shop = 'pdm' },




    --- Custom PDM Car
    { model = 'ikx3rebel22',         name = 'Cupra UrbanRebel',        brand = 'GCRP',           price = 75000,   category = 'coupes',    type = 'automobile',       shop = 'pdm' },
    { model = 'audirs8',             name = 'Audi RS8',                 brand = 'GCRP',          price = 121000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = 'xc90',                name = 'Volvo xc90',                    brand = 'GCRP',           price = 85000,   category = 'suvs',    type = 'automobile',       shop = 'pdm' },
    { model = 'RoyalCustome39m5_wb', name = 'BMW M5',     brand = 'GCRP',           price = 118000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = 'q8hycade',            name = 'Audi RS6',                brand = 'GCRP',           price = 120000,   category = 'suvs',    type = 'automobile',       shop = 'pdm' },
    { model = '18rs7',               name = 'Audi RS7',                   brand = 'GCRP',           price = 160000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = 'w140',                name = 'Mercedes W140',                    brand = 'GCRP',           price = 99000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = 'skyline',             name = 'Skyline R34',                 brand = 'GCRP',           price = 124000,   category = 'coupes',    type = 'automobile',       shop = 'pdm' },
    { model = 'rr21shelbystreet',    name = 'Shelby F150 crew cab',        brand = 'GCRP',           price = 100000,   category = 'offroad',    type = 'automobile',       shop = 'pdm' },
    { model = 'civic2020',           name = 'Civic2020 Type R',               brand = 'GCRP',           price = 80000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = 'passat',              name = 'Volkswagon Passat',                  brand = 'GCRP',           price = 120000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = 'mteche39',            name = 'BMW 328i',                brand = 'GCRP',           price = 138000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = '2f2fgts',             name = 'Mitsubishi Eclipse Sypder',                 brand = 'GCRP',           price = 100000,   category = 'coupes',    type = 'automobile',       shop = 'pdm' },
    { model = '350z',                name = 'Nissan 350z',                    brand = 'GCRP',           price = 122000,   category = 'sports',    type = 'automobile',       shop = 'pdm' },
    { model = 'rapger19',            name = 'Ford Raptor',                brand = 'GCRP',           price = 145000,   category = 'offroad',    type = 'automobile',       shop = 'pdm' },
    { model = 'polo2018',            name = 'Volkswagon Polo',                brand = 'GCRP',           price = 110000,   category = 'suvs',    type = 'automobile',       shop = 'pdm' },
    { model = 'c8p1',                name = 'Chevrolet Corvette C8',                brand = 'GCRP',           price = 70000,   category = 'sports',    type = 'automobile',       shop = 'pdm' },
    { model = 'rmodcharger',            name = 'Dodge Charger',                brand = 'GCRP',           price = 60000,   category = 'sedans',    type = 'automobile',       shop = 'pdm' },
    { model = 'KillerHwak',            name = 'Jeep Grand Cherokee Widebody Trackhawk',                brand = 'GCRP',           price = 300000,   category = 'suvs',    type = 'automobile',       shop = 'pdm' },

    --- Drift Vehicles
    { model = 'rmodm3joker',   name = 'rmodm3joker',                  brand = 'GCRP',           price = 115000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'r34h',          name = 'r34h',                         brand = 'GCRP',          price = 115000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 's15lunar',      name = 's15lunar',                     brand = 'GCRP',          price = 125000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'rx7veilside',   name = 'rx7veilside',                  brand = 'GCRP',          price = 100000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodskyline34', name = 'rmodskyline34',                brand = 'GCRP',          price = 80000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'silviagd',      name = 'silviagd',                  brand = 'GCRP',           price = 145000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'amarok',        name = 'amarok',                  brand = 'GCRP',           price = 112000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'variszupra',    name = 'variszupra',                  brand = 'GCRP',           price = 105000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodm4Unikat',  name = 'rmodm4Unikat',                  brand = 'GCRP',           price = 175000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'kgc10',         name = 'kgc10',                  brand = 'GCRP',           price = 45000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'golf91wideprzemo',   name = 'Volkswagon',                  brand = 'GCRP',           price = 45000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'dvc63darwin',   name = 'Mercedes',                  brand = 'GCRP',           price = 90000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'ckm3e36',   name = 'BMW',                  brand = 'GCRP',           price = 190000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'specialtf',   name = 'specialtf',                  brand = 'GCRP',           price = 40000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'singer',   name = 'Porsche',                  brand = 'GCRP',           price = 160000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'zlay_gtz35',   name = 'Nissan',                  brand = 'GCRP',           price = 95000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'RufusVanquish',   name = 'RufusVanquish',                  brand = 'GCRP',           price = 85000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'mk4hycade',   name = 'mk4hycade',                  brand = 'GCRP',           price = 200000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'GODzRB26SUBI',   name = 'GODzRB26SUBI',                  brand = 'GCRP',           price = 125000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'GODzDRIFTCAT',   name = 'GODzDRIFTCAT',                  brand = 'GCRP',           price = 130000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'GODz95GSX',   name = 'GODz95GSX',                  brand = 'GCRP',           price = 90000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'scubieblob',    name = 'scubieblob',                  brand = 'GCRP',           price = 100000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = '911turbos',     name = '911turbos',                  brand = 'GCRP',           price = 140000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'gtz34be',       name = 'gtz34be',                  brand = 'GCRP',           price = 110000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodm3joker',   name = 'rmodm3joker',                  brand = 'GCRP',           price = 90000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodm3joker',   name = 'rmodm3joker',                  brand = 'GCRP',           price = 90000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'rmodm3joker',   name = 'rmodm3joker',                  brand = 'GCRP',           price = 90000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'brz13varis',   name = 'brz13varis',                  brand = 'GCRP',           price = 90000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
    { model = 'rx7',   name = 'rx7',                  brand = 'GCRP',           price = 80000,    category = 'drift',        type = 'automobile', shop = 'pdm' },
