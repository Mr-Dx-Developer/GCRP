Config = {
    ...
    BallSetupCost = '$100', -- for example: "$1" or "$200" - any text 
    ...
    Text = {
        BACK = "Back",
        HIT = "Hit",
        BALL_IN_HAND = "Take the ball",
        BALL_IN_HAND_BACK = "Back",
        AIM_LEFT = "Turn Left",
        AIM_RIGHT = "Turn Right",
        AIM_SLOWER = "Slow Aiming",

        POOL = 'Billiards',
        POOL_GAME = 'Pool game',
        POOL_SUBMENU = 'Game Mode',
        TYPE_8_BALL = '8-Ball',
        TYPE_STRAIGHT = 'Straight pool',

        HINT_SETUP = 'Setup a Game',
        HINT_TAKE_CUE = 'Take a Cue',
        HINT_RETURN_CUE = 'Put the cue back..',
        HINT_HINT_TAKE_CUE = 'To play billiards, you need to get a cue.',
        HINT_PLAY = 'Play',
        ...
        BALL_POCKETED = '%s you put the ball in the hole',
        BALL_IN_HAND_NOTIFY = 'You Got the Billiard Ball',
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',
