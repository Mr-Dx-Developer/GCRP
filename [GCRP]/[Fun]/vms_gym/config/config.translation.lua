...
Config.Translate = {
    ['EN'] = {
        ...
        ["action.open_buymembership"] = "Appuyez sur ~INPUT_CONTEXT~ pour acheter une carte de membre",

        ['action.bench'] = "Appuyez sur  ~INPUT_CONTEXT~ se mettre sur le banc",
        ...
        ['action.barbell'] = "Appuyez sur ~INPUT_CONTEXT~ pour soulever la barre",
        ['action.dumbbells'] = "Appuyez sur ~INPUT_CONTEXT~ pour soulever des altères",
        ['action.treadmill'] = "Appuyez sur ~INPUT_CONTEXT~ pour courrir sur un tapis",

        ['progressbar.bench'] = "Vous faites du bench pressing",
        ['progressbar.pull-up'] = "Vous faites fais du pull up",
        ...
        ['progressbar.treadmill'] = "Vous courez sur un tapis roulant",

        ['menu.title.job_menu'] = "Menu de Gym",
        ['menu.element.grant_membership'] = "Accorder l'adhésion",
        ['menu.element.boss_menu'] = "Menu de BOSS",
        ['menu.title.select_player'] = 'Sélectionner un joueur',
        ['menu.element.grant_membership_to_player'] = "Accorder l'adhésion pour %s", -- %s = Player ID
        ['menu.title.select_membership_time'] = 'Sélectionnez le temps d\'adhésion',
        ['menu.element.membership'] = "Adhésion pour %s Jour(s) - <span style='color:green'>$%s</span>",

        ['question.title.buy_membership'] = "Adhésion",
        ['question.description.buy_membership'] = "Souhaitez-vous acheter un abonnement à une salle de sport de %s$ pour %s jours?",

        ['menu.title.buy_membership'] = "Adhésion",
        ['menu.element.accept_membership'] = "Acheter un abonnement de %s$ pour %s days",
        ['menu.element.reject_membership'] = "Refuser l'achat d'un abonnement",

        ['no_players_around'] = 'Personne à proximité.',

        ['notify.title.gym'] = "Menu de Gym",
        ['notify.title.strenght'] = "Force",
        ['notify.title.condition'] = "État",
        ['notify.title.driving'] = "Conduite",
        ['notify.title.shooting'] = "Tir",

        ['incrase_strenght'] = "+%s Force.",
        ['incrase_condition'] = "+%s État.",
        ['incrase_driving'] = "+%s Conduite.",
        ['incrase_shooting'] = "+%s Tir.",

        ['decrease_strenght'] = "-%s Force.",
        ['decrease_condition'] = "-%s État.",
        ['decrease_driving'] = "-%s Conduite.",
        ['decrease_shooting'] = "-%s Tir.",

        ['bought_membership'] = "Vous avez acheté un abonnement à une salle de sport.",
        ['no_money_for_membership'] = "Vous n'avez pas l'argent pour un abonnement à cette salle de sport.",

        ['selled_membership'] = "Vendu un abonnement à la salle de gym.",
        ['customer_did_not_buy'] = "Le client n'a pas acheté d'abonnement à la salle de sport.",

        ['out_of_breath'] = "Vous êtes à bout de souffle.<br>Entraînez votre condition en courant, en faisant du vélo ou en plongeant.",
        ['place_taken'] = "Cette place est prise.",
        ['no_membership'] = "Vous n'êtes pas abonné à cette salle de sport.",
    },
