...
Config.market_locations = {
	...
	["market_19"] = {
		['buy_price'] = 700000,
		['sell_price'] = 35000,
		['coord'] = {90.56, 285.77, 110.22},
		['garage_coord'] = {0,0,0,0},
...
Config.market_types = {
	...
	['mcdonalds'] = {							-- Market type ID
		...
		['blips'] = {							-- Create the blips on map
			['id'] = 78,						-- Blip ID [Set this value 0 to dont have blip]
			['name'] = "Market",				-- Blip Name [Will be replaced when the owner rename the store]
			['color'] = 46,						-- Blip Color
	...
	['alcohol_market'] = {
		...
		['items'] = {
			['beer'] = {						-- The item ID
				...
				['price_to_customer'] = 28,		-- Price the customer will pay when buy the product in store
	...
	['others_weapons'] = {
		...
		['items'] = {
			...
			['parachute_rainbow'] = {
				...
				['amount_to_owner'] = 5,
				['amount_to_delivery'] = 5,
				['img'] = 'parachute_rainbow.png',
			},
			['parparachute_darkredachute'] = {
				['name'] = "Darkred Parachute",
				['price_to_customer'] = 925,
				['price_to_customer_min'] = 1250,
				['price_to_customer_max'] = 5000,
				['price_to_export'] = 2500,
				['price_to_owner'] = 1875,
				['amount_to_owner'] = 5,
				['amount_to_delivery'] = 5,
				['img'] = 'parachute_darkred.png',
			},
			['parachute_yellow'] = {
				['name'] = "Yellow Parachute",
				['price_to_customer'] = 785,
				['price_to_customer_min'] = 1250,
				['price_to_customer_max'] = 5000,
				['price_to_export'] = 2500,
				['price_to_owner'] = 1875,
				['amount_to_owner'] = 5,
				['amount_to_delivery'] = 5,
				['img'] = 'parachute_yellow.png',
			},
			['parachute_red'] = {
				['name'] = "Red Parachute",
				['price_to_customer'] = 885,
				['price_to_customer_min'] = 1250,
				['price_to_customer_max'] = 5000,
				['price_to_export'] = 2500,
				['price_to_owner'] = 1875,
				['amount_to_owner'] = 5,
				['amount_to_delivery'] = 5,
				['img'] = 'parachute_red.png',
			},
			['parachute_white'] = {
				['name'] = "White Parachute",
