	...
	while true do 	
		...
		if idontknowwhatimdoing then
			if IsPedInAnyVehicle(PlayerPedId(), false) then
				...
				if count0 then
					drawTxt(0.8, 0.64, 0.4,0.4,0.30, "0-50: " .. countdown0 .. "s", 245, 217, 39, 255)
				elseif not count0 then
					drawTxt(0.8, 0.64, 0.4,0.4,0.30, "0-50: " .. countdown0 .. "s", 39, 245, 58, 255)
				end

				if count1 then
					drawTxt(0.8, 0.66, 0.4,0.4,0.30, "0-100: " .. countdown1 .. "s", 245, 217, 39, 255)
				elseif not count1 then
					drawTxt(0.8, 0.66, 0.4,0.4,0.30, "0-100: " .. countdown1 .. "s", 39, 245, 58, 255)
				end

				if count2 then
					drawTxt(0.8, 0.68, 0.4,0.4,0.30, "0-150: " .. countdown2 .. "s", 245, 217, 39, 255)
				elseif not count2 then
					drawTxt(0.8, 0.68, 0.4,0.4,0.30, "0-150: " .. countdown2 .. "s", 39, 245, 58, 255)
				end

				if count3 then
					drawTxt(0.8, 0.70, 0.4,0.4,0.30, "0-180: " .. countdown3 .. "s", 245, 217, 39, 255)
				elseif not count3 then
					drawTxt(0.8, 0.70, 0.4,0.4,0.30, "0-180: " .. countdown3 .. "s", 39, 245, 58, 255)
				end
	...
	while true do
		...
		if idontknowwhatimdoing then
			if (GetEntitySpeed(GetVehiclePedIsIn(PlayerPedId(), false))*ihatemphbuteveryoneusesit) > 1 and count1 then
				if (GetEntitySpeed(GetVehiclePedIsIn(PlayerPedId(), false))*ihatemphbuteveryoneusesit) < 50 then
			...
			if (GetEntitySpeed(GetVehiclePedIsIn(PlayerPedId(), false))*ihatemphbuteveryoneusesit) > 1 and count2 then
				if (GetEntitySpeed(GetVehiclePedIsIn(PlayerPedId(), false))*ihatemphbuteveryoneusesit) < 150 then
			...
			if (GetEntitySpeed(GetVehiclePedIsIn(PlayerPedId(), false))*ihatemphbuteveryoneusesit) > 1 and count3 then
				if (GetEntitySpeed(GetVehiclePedIsIn(PlayerPedId(), false))*ihatemphbuteveryoneusesit) < 180 then
					countdown3 = (countdown3 + 0.1)
				end
