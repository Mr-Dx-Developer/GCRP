...
local Vehicles = {
    ...
    { model = 'omnisegt',      name = 'Omnis e-GT',                    brand = 'Obey',            price = 185000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel4',     name = 'Sentinel Classic Widebody',     brand = 'Übermacht',       price = 140000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'sm722',         name = 'SM722',                         brand = 'Benefactor',      price = 125000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'tenf',          name = '10F',                           brand = 'Obey',            price = 185000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'tenf2',         name = '10F Widebody',                  brand = 'Obey',            price = 215000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'corsita',       name = 'Corsita',                       brand = 'Lampadati',       price = 90000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    --- Super (7)
    { model = 'adder',         name = 'Adder',                         brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'autarch',       name = 'Autarch',                       brand = 'Överflöd',        price = 224000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'banshee2',      name = 'Banshee 900R',                  brand = 'Bravado',         price = 120000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'bullet',        name = 'Bullet',                        brand = 'Vapid',           price = 120000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'cheetah',       name = 'Cheetah',                       brand = 'Grotti',          price = 214000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'cyclone',       name = 'Cyclone',                       brand = 'Coil',            price = 300000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'entity2',       name = 'Entity XXR',                    brand = 'Överflöd',        price = 164000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'entityxf',      name = 'Entity XF',                     brand = 'Överflöd',        price = 180000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'emerus',        name = 'Emerus',                        brand = 'Progen',          price = 220000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'fmj',           name = 'FMJ',                           brand = 'Vapid',           price = 125000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'furia',         name = 'Furia',                         brand = 'Grotti',          price = 230000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'gp1',           name = 'GP1',                           brand = 'Progen',          price = 110000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'infernus',      name = 'Infernus',                      brand = 'Pegassi',         price = 235000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'italigtb',      name = 'Itali GTB',                     brand = 'Progen',          price = 170000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'italigtb2',     name = 'Itali GTB Custom',              brand = 'Progen',          price = 250000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'krieger',       name = 'Krieger',                       brand = 'Benefactor',      price = 222000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'le7b',          name = 'RE-7B',                         brand = 'Annis',           price = 260000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'nero',          name = 'Nero',                          brand = 'Truffade',        price = 200000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'nero2',         name = 'Nero Custom',                   brand = 'Truffade',        price = 260000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'osiris',        name = 'Osiris',                        brand = 'Pegassi',         price = 220000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'penetrator',    name = 'Penetrator',                    brand = 'Ocelot',          price = 130000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'pfister811',    name = '811',                           brand = 'Pfister',         price = 220000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'prototipo',     name = 'X80 Proto',                     brand = 'Grotti',          price = 235000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'reaper',        name = 'Reaper',                        brand = 'Pegassi',         price = 100000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 's80',           name = 'S80RR',                         brand = 'Annis',           price = 205000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'sc1',           name = 'SC1',                           brand = 'Übermacht',       price = 90000,   category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'sheava',        name = 'ETR1',                          brand = 'Emperor',         price = 220000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    ...
    { model = 'tempesta',      name = 'Tempesta',                      brand = 'Pegassi',         price = 120000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'tezeract',      name = 'Tezeract',                      brand = 'Pegassi',         price = 220000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'thrax',         name = 'Thrax',                         brand = 'Truffade',        price = 180000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'tigon',         name = 'Tigon',                         brand = 'Lampadati',       price = 240000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'turismor',      name = 'Turismo R',                     brand = 'Grotti',          price = 140000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'tyrant',        name = 'Tyrant',                        brand = 'Överflöd',        price = 2100000, category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'tyrus',         name = 'Tyrus',                         brand = 'Progen',          price = 230000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'vacca',         name = 'Vacca',                         brand = 'Pegassi',         price = 105000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'vagner',        name = 'Vagner',                        brand = 'Dewbauchee',      price = 1660000, category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'voltic',        name = 'Voltic',                        brand = 'Coil',            price = 120000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'voltic2',       name = 'Rocket Voltic',                 brand = 'Coil',            price = 9830400, category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'xa21',          name = 'XA-21',                         brand = 'Ocelot',          price = 180000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'zentorno',      name = 'Zentorno',                      brand = 'Pegassi',         price = 340000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'zorrusso',      name = 'Zorrusso',                      brand = 'Pegassi',         price = 277000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    ...
    { model = 'deveste',       name = 'Deveste',                       brand = 'Principe',        price = 234000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'lm87',          name = 'LM87',                          brand = 'Benefactor',      price = 155000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'torero2',       name = 'Torero XO',                     brand = 'Pegassi',         price = 245000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'entity3',       name = 'Entity MT',                     brand = 'Overflod',        price = 200000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'virtue',        name = 'Virtue',                        brand = 'Ocelot',          price = 72000,   category = 'super',          type = 'automobile', shop = 'pdm' },
    --- Motorcycles (8)
