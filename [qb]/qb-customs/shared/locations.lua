 ...
 Config.Locations = {
     ['MRPD'] = {
         ...
         zones = {
             ...
             { coords = vector3(374.07, -1622.01, 29.29), length = 9.0, width = 4.0, heading = 319.52, minZ = 27.5, maxZ = 30.5 },  --- devis
             { coords = vector3(1815.12, 3680.35, 33.97), length = 9.0, width = 4.0, heading = 29.31, minZ = 30.0, maxZ = 35.5 },  --- BCSO

             { coords = vector3(-447.88, 5994.43, 31.34), length = 9.0, width = 4.0, heading = 82.17, minZ = 25.0, maxZ = 35.0 },  --- BCSO s
         }
     },
     ...
     ['Pillbox'] = {
         ...
         zones = {
             { coords = vector3(-501.26, -339.74, 34.39), length = 9.4, width = 4.2, heading = 262.79, minZ = 32.5, maxZ = 36.5 },
