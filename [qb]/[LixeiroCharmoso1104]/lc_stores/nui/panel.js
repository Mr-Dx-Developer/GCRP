			...
			$('#upgrades-page').append(`
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
					<div class="card shadow-sm border-0">
						<div class="card-body rounded card-theme p-4"><img src="https://cdn.discordapp.com/attachments/533398980428693550/804898333192880128/shop.png" alt="" class="img-fluid d-block mx-auto mb-3">
				...
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
					<div class="card shadow-sm border-0">
						<div class="card-body rounded card-theme p-4"><img src="https://cdn.discordapp.com/attachments/533398980428693550/804898331159298078/delivery-truck.png" alt="" class="img-fluid d-block mx-auto mb-3">
				...
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
					<div class="card shadow-sm border-0">
						<div class="card-body rounded card-theme p-4"><img src="https://cdn.discordapp.com/attachments/533398980428693550/804898332371189780/manager.png" alt="" class="img-fluid d-block mx-auto mb-3">
