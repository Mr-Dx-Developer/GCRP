...
RegisterCommand('inventory', function()
    ...
    if  exports['qb-smallresources']:getHandsup() then
        return QBCore.Functions.Notify("Can't open Inventory with your hands up", "error")
    end
...
for i = 1, 6 do
    RegisterCommand('slot' .. i,function()
        if  exports['qb-smallresources']:getHandsup() then
            return QBCore.Functions.Notify("Can't use your slot with your hands up", "error")
        end
