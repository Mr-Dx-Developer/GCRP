...
document.onkeyup = function (data) {
  if (data.which == 27) {
    $.post('https://McDonalds/exit', JSON.stringify({}));
    return
  }
};
...
function sumaTotal() { //hace la suma del total.
  ...
  if (!($(combomeal).css("display") == "none")) { 
    var preciocombomeal = Number('300');
  ...
  if (!($(mcroyaldeluxe).css("display") == "none")) {
    var preciomcroyaldeluxe = Number('60');
  ...
  if (!($(cuartodelibra).css("display") == "none")) {
    var preciocuartodelibra = Number('60');
  ...
  if (!($(grandmcextreme).css("display") == "none")) {
    var preciograndmcextreme = Number('60');
  ...
  if (!($(bigchickensupreme).css("display") == "none")) {
    var preciobigchickensupreme = Number('60');
  ...
  if (!($(bigcrispybbq).css("display") == "none")) {
    var preciobigcrispybbq = Number('60');
  ...
  if (!($(bigdoublecheese).css("display") == "none")) {
    var preciobigdoublecheese = Number('60');
  ...
  if (!($(hamburgesa).css("display") == "none")) {
    var preciohamburgesa = Number('60');
  ...
  if (!($(happymeal).css("display") == "none")) {
    var preciohappymeal = Number('300');
  ...
  if (!($(monsterenergy).css("display") == "none")) {
    var preciomonsterenergy = Number('80');
  ...
  console.log("Order Total:", total, "RM");
}
...
function finalizarpedido() {
  ...
  if (!($(combomeal).css("display") == "none")) { 
    var cantidadcombomeal = parseInt(document.getElementById('combomealnumber').value, 10); 
    $.post('https://McDonalds/realizarpedido', JSON.stringify({
      item: "combomeal",
      price: 300,
  ...
  console.log("Order done, total:", total, "RM");
  close()
  sumaTotal();
  $.post('https://McDonalds/exit', JSON.stringify({}))
}