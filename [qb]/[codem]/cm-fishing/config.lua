...
Config.DatabaseRewardName = "codem_fishing_rewards"
Config.OxInventory = false -- if you are using ox inventory please set this true for CanCarryItem
Config.TextUIHandler = {
    type = 'default', -- default, esx_textui, qb_default_textui, custom , false
...
Config.Notifications = { -- Notifications
    ...
    ["alreadystarted"] = {
        message = 'Fishing already started.',
        type = "error",
    },
    ["spam"] = {
